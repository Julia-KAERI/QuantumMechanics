...
로 정의된다. 이 때 $\sum_i |\alpha_i|^2 = \sum_j |\beta_j|^2 = 1$ 이어야 하며, 

$$
\sum_{i, j} |\alpha_i \beta_j|^2 = \sum_i |\alpha_i|^2\left(\sum_j |\beta_j|^2\right) = 1
$$
