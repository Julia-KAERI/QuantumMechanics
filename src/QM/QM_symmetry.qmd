...
라고 하자. @eq-QM_translation_operator 는 근사식이며 많은 계산에서 $\varepsilon$ 에 대한 1차식가지만의 결과가 사용되기 때문에 편리하다. 이 때 $G$ 는 translation 의 generator 라고 한다. $G$ 가 애르미트 연산자임은 쉽게 보일 수 있다.
