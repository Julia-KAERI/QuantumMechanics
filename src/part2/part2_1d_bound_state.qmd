...
![(좌) 무한 포텐셜 우물, (우) 가장 낮은 두 파동함수](figures/infinite_potential_well.png){#fig-part2_infinite_potential_well width=600}
...
![($a$) 짝함수의 경우에서의 허용된 $\kappa$ 값 ($b$) 홀함수의 경우 허용된 $\kappa$ 값. 스케일을 위해 가로축을 $ka$ 로, 세로축을 $\kappa a$ 로 잡았다. ](figures/solution_of_potential_well.png){#fig-part2_energy_qunatization_of_potential_well width=800}
