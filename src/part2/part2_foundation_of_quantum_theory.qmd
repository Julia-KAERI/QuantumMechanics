...
### 디랙 댈타 함수 {#sec-part2_dirac_delta_function}

양자역학에서 위치 $x$ 나 운동량 $p$ 와 같은 연속적인 값을 다루는데는 디렉 댈타 함수 $\delta (x)$ 가 필수적이다.

::: {.callout-note appearance="minimal"}

::: {#def-part2_dirac_delta_function}
...
::: {#prp-part2_properties_of_dirac_delta_function}
...
를 얻는다. 정규화 조건 $\langle p'|p\rangle = \delta (p-p')$ 과 @prp-part2_properties_of_dirac_delta_function 의 ($7$) 로부터
