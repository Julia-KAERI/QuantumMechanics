...
![($0, 0)$ 과 $(1, 1)$ 을 잇는 두 경로](figures/path_integral_2.png){#fig-part2_path_integral_2 width=250}
...
![경로적분의 이산 근사](figures/path_integral_3.png){#fig-part2_path_integral_3 width=500}
